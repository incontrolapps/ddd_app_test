<script>
    ...
    export async function load() {<br>
        &ensp;const request = await fetch("<a href='http://85.210.161.184/api?what=*&table=vw_LocalAuthorityMetricsExportFull&where=ONSCode%20=%20%27FA001%27%20AND%20MetricCode%20=%20%27FM001%27'>http://85.210.161.184/api?what=*&table=vw_LocalAuthorityMetricsExportFull&where=ONSCode = 'FA001' AND MetricCode = 'FM001'</a>");<br>
